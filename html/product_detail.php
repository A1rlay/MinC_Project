...
<head>
    ...
    <title>Product Details - MinC Auto Parts</title>
...
<div class="hidden md:flex items-center space-x-8">
    <a href="../index.php#about-us" class="nav-link-custom text-gray-700 font-medium">About Us</a>
    <a href="product.php" class="nav-link-custom text-gray-700 font-medium">Products</a>
    <a href="../index.php#categories" class="nav-link-custom text-gray-700 font-medium">Categories</a>
    <a href="../index.php#contact-us" class="nav-link-custom text-gray-700 font-medium">Contact</a>
</div>

                <!-- Right Menu -->
                <div class="hidden md:flex items-center space-x-6">
                    <!-- Cart -->
<a href="user-cart.php" class="relative text-gray-700 hover:text-[#08415c] transition">
