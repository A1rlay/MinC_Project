                   ...
                   <th scope="row" class="border-0">
                        <div class="p-2">
                            ...
                            <div class="ml-3 d-inline-block align-middle">
                                <h5 class="mb-0"> <a href="product_detail.php?p_id=${product.product_id}"
      ...
      `<div class="col-lg-12 d-flex justify-content-center">
          <div>
            ...
            <div class="d-flex justify-content-center">
                <a href="../index.php#shop-by-category" class="btn d-inline-block align-middle mt-2">RETURN TO SHOP</a>     
            </div>
          </div>
       </div>`;
  }
