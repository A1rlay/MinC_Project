        ...
        if (product_detail.p_id == pid) {
          ...
          document.querySelector(".products-container").innerHTML = products
            ...
            <div class="col-md-6 product-det">
                <p><p><b> <a href="../index.php">Home</a> / <a href="../index.php#${category.id}"> ${category.autoPart}</a> / <a href="product.html?id=${category.id}&c_id=${sub_cat.c_id}"> ${sub_cat.name} </a> / ${product_detail.name} </b></p>
                <hr></p>
                <h1>${product.name}</h1>
                ...
                document.querySelector(".similar-products").innerHTML = similar_products.map((similarProduct, index) => {
                  if (index < 3) {
                    return `<div class="col-md-4 text-center">
                              <a href="product_detail.php?p_id=${similarProduct.p_id}"><img src="${similarProduct.url1}" height="300" ></a>
                              <a href="product_detail.php?p_id=${similarProduct.p_id}"><h6 class="mt-2 similar-product-heading">${similarProduct.name}</h6></a>
